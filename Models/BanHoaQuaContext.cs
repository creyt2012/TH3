...
namespace TH3_Harmic.Models;

public partial class BanHoaQuaContext : DbContext
{
    public BanHoaQuaContext()
    {
    }

    public BanHoaQuaContext(DbContextOptions<BanHoaQuaContext> options)
        : base(options)
    {
    }
